...
public class Main {                                                                                                                                                   
    ...
    /* M: Positive: if inside loop, count down loop */
...
/* Positive: if inside loop, count down loop */
    ...
    /* M: Negative because of function call (unable to clone):  if inside loop, i is modified inside if , reference type in if */
    ...
    /* M: Negative:  nested if results in more than 5 basic blocks in the loop: optimization limitation */
    /* N: positive, Loop gate passed, no more limitations on basic blocks number */
    ...
    /* M: Negative (function call in loop header -> unable to clone):  if outside loop */
    /* N: positive, Loop gate passed (cloner improved) */
