...
package OptimizationTests.AutoFastJNIDetection.TryCatchJava02;
...
public class Main {
    ...
    public native int nativeTryCatchJava02(int a, int b, int c); 

    public int inlineNativeCall(int a, int b, int c) {
        return nativeTryCatchJava02(a, b, c);
    }
