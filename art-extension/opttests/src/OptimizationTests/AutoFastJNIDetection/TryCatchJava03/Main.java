...
package OptimizationTests.AutoFastJNIDetection.TryCatchJava03;
...
public class Main {
    ...
    public native int nativeTryCatchJava03(int a, int b, int c); 

    public int inlineNativeCall(int a, int b, int c) {
        return nativeTryCatchJava03(a, b, c);
    }
