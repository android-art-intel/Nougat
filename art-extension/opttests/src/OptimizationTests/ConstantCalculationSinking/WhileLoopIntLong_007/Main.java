...
package OptimizationTests.ConstantCalculationSinking.WhileLoopIntLong_007;

/**
 *
 * While loop with IV other than 1 and condition that uses sink candidate
