...
package OptimizationTests.AUR.Suspend_01;
...
public class Main {
    ...
    // simple AUR example for Suspend (generated by LHSS pass)
    public String runTest (int[] array, int start, int end, Main other, Main m) {
        String str = "1234";
    ...
    public String test(int n) {
        ...
        res =  runTest(array, 1, n*1000, other, m);;
