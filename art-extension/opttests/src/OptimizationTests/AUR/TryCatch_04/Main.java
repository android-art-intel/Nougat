...
package OptimizationTests.AUR.TryCatch_04;
...
public class Main {
    ...
    // simple AUR example with try-catch block with DivZeroCheck in try section; 
    // AUR will clean up environemnt before and after try-catch, inside catch block, but not inside try block
