...
package OptimizationTests.AUR.NullCheck_03;
...
public class Main {
    ...
    // simple AUR example for NullCheck, Rem instruction will also be removed because it will not be used by environment
    // more complex test, more uses of variables
    public int runTest (int n, Main unusedVar, Main other, String str1) {
        int sum = 0;
        sum = unusedVar.field % 3;
        sum = other.field % 3;
    ...
    public int test(int n) {
        ...
        Main other = new Main();
        return runTest(n, unusedVar, other, "str1");
    }
