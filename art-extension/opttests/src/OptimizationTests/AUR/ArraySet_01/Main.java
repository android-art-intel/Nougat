...
package OptimizationTests.AUR.ArraySet_01;
...
public class Main {
    ...
    public int runTest (int x, int n, Main m, Main other, Object[] myArray, Main unused) {
    ...
    public int test(int n) {
        ...
        return runTest(n%3, n, unusedVar, other, myArray, unusedVar);
    }
