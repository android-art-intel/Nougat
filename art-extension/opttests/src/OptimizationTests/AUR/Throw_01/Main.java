...
package OptimizationTests.AUR.Throw_01;
...
public class Main {
    ...
    // simple AUR example for Throw instruction
    public void runTest (int n, int x, Main other, Exception ex) throws Exception {
//        if (n > 10) {
            throw ex;
//        }
//        return other.field;
    ...
    public int test(int n) {
        Main other = new Main();
        Exception ex = new Exception("Throwing custom exception");
        try {
            runTest(n, 6, other, ex);
        } catch (Exception e) {
