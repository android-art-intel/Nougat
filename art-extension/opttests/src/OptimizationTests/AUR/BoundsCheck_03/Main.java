...
package OptimizationTests.AUR.BoundsCheck_03;
...
public class Main {
    ...
    // simple AUR example for BoundsCheck, 
    // same as BoundsCheck_01, but ArrayGet will not be removed because it is used later
    public int runTest (int[] xx, int n, Main other) {
        int sum = xx[n - 5];
        return other.field + sum;
