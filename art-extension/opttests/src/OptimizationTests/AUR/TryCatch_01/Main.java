...
package OptimizationTests.AUR.TryCatch_01;
...
public class Main {
    ...
    // simple AUR example for try-catch block with DivZeroCheck in try section: environment of DivZeroCheck is not removed
    // but environemnt of NullCheck and instruction LoadException (no side effects) outside of try-catch block are removed
