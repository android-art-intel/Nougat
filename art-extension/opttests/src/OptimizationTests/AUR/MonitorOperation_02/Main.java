...
package OptimizationTests.AUR.MonitorOperation_02;
...
public class Main {
    ...
    // simple AUR example for MonitorOperation, several MonitorOperations in a row + nested
    public int runTest (int n, Main m, Main other) {
