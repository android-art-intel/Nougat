...
package OptimizationTests.AUR.TryCatch_03;
...
public class Main {
    ...
    // environment of DivZeroCheck and unused instructions are not removed inside TryBoundary entry-exit, but are removed outside;
