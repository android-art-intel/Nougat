...
package OptimizationTests.AUR.RemovePureInvoke_03;
...
public class Main {
    ...
    public double runTest (int x, int n, Main m, Main other, String a, int b, int c) {
      ...
      b = foo(a, 11); // foo is inlined with pure non-static non-intrinsic invoke of lastIndexOf; NullCheck and InvokeStaticOrDirect have parent environemnt from foo;
