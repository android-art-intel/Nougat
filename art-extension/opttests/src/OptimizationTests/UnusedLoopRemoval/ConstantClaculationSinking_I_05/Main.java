...
package OptimizationTests.UnusedLoopRemoval.ConstantClaculationSinking_I_05;

public class Main {

    // M: loop becomes unused after Constant Calculation Sinking pass
    ...
    public int loop() {
       ...
       for (int i = 0; i < 10000; i++) {
            ...
            used15 %= invar15 - invar16;
            used16 += invar16 + invar17;
            used17 -= invar17 - invar18;
            used18 /= invar18 * invar19;
            used19 *= invar19 + invar0;
        }
