...
CAPSTONE_EXT_LIBRARY := $(strip $(wildcard $(ANDROID_BUILD_TOP)/capstone/Android.mk))
ifneq ($$(CAPSTONE_EXT_LIBRARY),)
  ART_C_INCLUDES += capstone/include
endif
  ...
  ifneq ($(ART_COVERAGE),true)
    ifneq ($(NATIVE_COVERAGE),true)
      ...
      ifdef SANITIZE_TARGET
        ...
        art_target_non_debug_cflags += -Wframe-larger-than=1900
      endif
    endif
  endif
endif
