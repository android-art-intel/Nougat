...
#ifndef ART_RUNTIME_GC_GCVIEW_MM_H_

#define ART_RUNTIME_GC_GCVIEW_MM_H_
...
inline void* operator new(size_t size_bytes) {
  return art::gc::gcview::MM::alloc(size_bytes, false /* is_array */);
}

inline void* operator new[](size_t size_bytes) {
  return art::gc::gcview::MM::alloc(size_bytes, true /* is_array */);
}

inline void operator delete(void* ptr) {
  art::gc::gcview::MM::free(ptr, false /* is_array */);
}
...
#endif // ART_RUNTIME_GC_GCVIEW_MM_H_
