...
#ifndef ART_RUNTIME_GC_GCVIEW_DATA_H_

#define ART_RUNTIME_GC_GCVIEW_DATA_H_
...
protected:
  ...
  void validateEnumValue(uintptr_t value) const {
    ...
    GCVIEW_ASSERT(_enum_members != nullptr);
...
public:
  ...
  bool isEqualTo(T value) const { return (_value >= value) && (_value <= value); }
};
...
public:
  ...
  static const char* getDefault() { return nullptr; }

  StringElement() : _str(nullptr) { }
...
public:
  ...
  ValueData(const char* name, const char* group_name = nullptr)
...
public:
  ...
  void set(unsigned index, T val) { _array[index] = val; }

  Element<ET>& value(unsigned index) { return _array[index]; }

  ArrayData(const char* name, const char* group_name = nullptr)
...
#endif // ART_RUNTIME_GC_GCVIEW_DATA_H_
