...
#ifndef ART_RUNTIME_GC_GCVIEW_ARRAY_H_

#define ART_RUNTIME_GC_GCVIEW_ARRAY_H_

#include "utils.h"

#define GCVIEW_ARRAY_MAX_LENGTH 40960

#define GCVIEW_ARRAY_ITERATE(__array__, __type__, __elem__, __cmd__) \
do { \
  GCVIEW_ASSERT((__array__) != nullptr); \
...
#endif // ART_RUNTIME_GC_GCVIEW_ARRAY_H_
