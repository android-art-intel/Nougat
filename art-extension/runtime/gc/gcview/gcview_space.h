...
#ifndef ART_RUNTIME_GC_GCVIEW_GCVIEW_SPACE_H_

#define ART_RUNTIME_GC_GCVIEW_GCVIEW_SPACE_H_
...
public:
  ...
  gc::Manipulator* getManipulator() { return _manipulator; }
  
  void setManipulator(gc::Manipulator* manipulator) {
    _manipulator = manipulator;
  }

  Data* addData(Data* data);
  template <typename D>
  D* addData(const char* name, const char* group_name = nullptr) {
...
#endif // ART_RUNTIME_GC_GCVIEW_SPACE_H_
