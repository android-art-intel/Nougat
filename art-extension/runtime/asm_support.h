...
#define THREAD_LOCAL_OBJECTS_OFFSET (THREAD_CARD_TABLE_OFFSET + 172 * __SIZEOF_POINTER__)
...
#define SHADOWFRAME_PROFILING_ACTIVE_OFFSET (SHADOWFRAME_NUMBER_OF_VREGS_OFFSET + 12)
ADD_TEST_EQ(SHADOWFRAME_PROFILING_ACTIVE_OFFSET,
            static_cast<int32_t>(art::ShadowFrame::ProfilingActiveOffset()))
